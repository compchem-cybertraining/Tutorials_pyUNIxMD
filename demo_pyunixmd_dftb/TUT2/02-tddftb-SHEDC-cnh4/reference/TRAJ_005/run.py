...
# Determine MD method.
md = mqc.SH(molecule=mol, thermostat=thermo, nsteps=120, nesteps=1000, dt=0.25, istate=2, elec_object="density", hop_rescale="energy", hop_reject="keep", dec_correction="edc")
